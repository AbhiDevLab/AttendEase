            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between space-y-0">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Get alerts when your attendance falls below threshold</p>
                </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between space-y-0">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Allow the app to access your location for attendance verification
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between space-y-0">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Allow the app to access your camera for QR code scanning
                  </p>
                </div>
